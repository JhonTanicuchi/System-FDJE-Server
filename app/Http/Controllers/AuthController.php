...
class AuthController extends Controller
{
    ...
    public function getProfile()
    {
        ...
        try {
            ...
            $user->load(['person', 'person.nationality', 'person.identification_type'])->only(['id', 'email', 'active', 'person.id', 'person.name', 'person.last_name', 'person.email', 'person.phone', 'person.birth_date', 'person.identification', 'person.nationality', 'person.identification_type']);
